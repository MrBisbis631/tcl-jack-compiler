...
# return label for ending a function block
proc end_function_label {func_name} {
  return "END__$func_name\n"
}

# return label for caller of a function
proc end_call_function_label {func_name} {
  return "END_CALL__$func_name\n_[number_gen]"
}
...
proc hack_function {filename func_name args_count} {
